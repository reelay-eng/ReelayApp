...
const appReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case "setItemAddRemoveToWatchList":
      return { ...state, isItemAddedToWatchList: action.payload };
    ...
    case "setUpdatedWatchlistItem":
      ...
      const updatedMyWatchlistItems = updateWatchlistReducer(
        state.myWatchlistItems,
        updatedItem
      );
    ...
    case "updateHomeGuessingGames":
      ...
      const nextGuessingGames = updateGuessingGameReducer(
        guessingGames,
        updatedGame
      );
    ...
    case "setAppVersionInfo":
      ...
      if (minVersionRequired > state.currentAppVersion)
        return {
          ...state,
          appUpdateRequired: true,
          recommendedAppVersion: recommendedVersion,
          requiredAppVersion: minVersionRequired,
        };
      else if (recommendedVersion > state.currentAppVersion)
        return {
          ...state,
          appUpdateRecommended: true,
          recommendedAppVersion: recommendedVersion,
          requiredAppVersion: minVersionRequired,
        };
      return {
...
export const mapStateToProps = (state) => ({
  ...
  isItemAddedToWatchList: state.isItemAddedToWatchList,
