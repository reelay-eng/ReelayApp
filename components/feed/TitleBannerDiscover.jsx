...
const TitleBannerDiscover = ({ 
    ...
    // console.log("isHowtoReelay",reelay)
    if (isWelcomeReelay) {
    ...
    const Poster = () => {
        return (
            <TitlePosterContainer>
                <TitlePoster title={titleObj} onPress={openTitleDetail} width={35} />
            </TitlePosterContainer>
        );
    }
...
export default memo(TitleBannerDiscover, areEqual);