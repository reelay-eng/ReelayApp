...
const ReelayTile = ({
  ...
  const showFeedTutorialOnStack =
    showFeedTutorial && stack?.topicType !== "guessingGame" && stackViewable;
    ...
    [
      {
        ...
        content: {
          venue: "disney",
          videoURI:
            "https://di92fpd9s7eko.cloudfront.net/public/reelayvid-a5addf82-69d6-4451-a6fe-f0ae4583294b-1689569484751.mp4",
        },
        creator: {
      ...
      },
      {
        ...
        content: {
          venue: "disney",
          videoURI:
            "https://di92fpd9s7eko.cloudfront.net/public/reelayvid-51a34eb3-c902-4ce0-a87c-f57b503b2503-1684979182900.mp4",
        },
        creator: {
          avatar: "../../assets/images/icon.png",
  ...
  if (typeof reelData !== "undefined" && reelData.length !== 0) {
    ...
    dataProvider = dataProvider.cloneWithRows(
      reelData?.length == 0 ? reelData : data
    );
  }
